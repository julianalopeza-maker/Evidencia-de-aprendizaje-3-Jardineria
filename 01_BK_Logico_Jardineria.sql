/*
Descripción:
- Crea la base de datos operacional `jardineria`.
- Crea el modelo relacional original de Jardinería en MySQL.
- Carga todos los datos respetando las claves primarias y foráneas del modelo.
*/
